...
public class InitTestContainer extends TestContainer {

    public InitTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/groupstp/init/app.properties",
    ...
    public static class Common extends InitTestContainer {

        public static final InitTestContainer.Common INSTANCE = new InitTestContainer.Common();
